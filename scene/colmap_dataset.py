...
class Colmap_Dataset(Dataset):
    def __init__(
        ...
        # TEST VRU dataset: every 20 frames
        # self.first_frame = 0
        # self.final_frame = 20
        # TEST MeetRoom dataset: 300 frames
        self.first_frame = 100
        self.final_frame = 120
        print(f"    colmap dataset: from {self.first_frame} to {self.final_frame}, total {self.final_frame - self.first_frame} frames")
    ...
    def load_images_path(self,frames_paths):
        ...
        # image_paths:{t=1, cam1...N}{t=2, cam1...N}...{t=T, cam1...N}
