...
for i in range(0,13):  # Total videos you want to process
    video_id = f'cam_{i:02d}'
    video_filename = os.path.join("/data/dly/swift4d/data/meetroom/discussion", video_id+".mp4")  # Maybe you need to modify the file input path to match your data.
    base_folder = "/data/dly/swift4d/data/meetroom/discussion"+ "/frame"
