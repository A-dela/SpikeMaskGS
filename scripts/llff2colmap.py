...
if "nvidia" in root_dir and "dynlbar" in root_dir: #
...
for index, video_path in enumerate(videos):
    ...
    if os.path.exists(os.path.join(video_path, "images", "0000.png")):
        image_path = os.path.join(video_path, "images", "{:04d}.png".format(0))
    else:
        image_path = os.path.join(video_path, "images", "{:04d}.jpg".format(0))
...
print(1,"SIMPLE_PINHOLE",1352,1014,focal[0],1352/2,1014/2,file=object_cameras_file) #dynerf
# print(1,"SIMPLE_PINHOLE",1222,684,focal[0],1222/2,684/2,file=object_cameras_file) #dynerf
# print(1,"SIMPLE_PINHOLE",960,506,focal[0],960/2,506/2,file=object_cameras_file)
# print(1,"SIMPLE_PINHOLE",960,540,focal[0],960/2,540/2,file=object_cameras_file)
# print(1,"SIMPLE_PINHOLE",int(W),int(H),focal[0],int(W)/2,int(H)/2,file=object_cameras_file)
