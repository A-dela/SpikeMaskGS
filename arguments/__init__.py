...
class PipelineParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.cluster = False
        self.begin_tracker = False
        self.sigmoid_binary = False
        self.dsh = False
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.dynamic_thro = 7.0
        self.weight_prune_from_iter = 3000
        self.weight_prune_interval = 3000
        self.weight_prune_threshold = 0.02
        self.n_levels = 16
        ...
        self.lambda_dynamic_loss = 0
        # snn
        self.train_dynamic_coarse = False
        self.lambda_static_loss = 0.0
        self.IF_thresh = 0.0
        
        # robust
        self.loss_threshold = 0.1
        self.schedule_beta = -3e-3
        self.bin_size = 10000
